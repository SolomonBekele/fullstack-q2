...
The sitemap.xml file defines how the web application is structured and navigated by search engines.
       It contains two major URL groups:
           - **Pre-login pages
           - **Post-login pages
...
<!-- Pre-login Page -->
<url>
    <loc>https://etchat-web.etchat.et/</loc>
    <changefreq>daily</changefreq>
    <priority>1.0</priority>
</url>
<!-- Post-login Pages -->
<url>
    <loc>https://etchat-web.etchat.et/dashboard</loc>
...
- **Improved Discovery:** Tells search engines which pages exist on the website
...
The robots.txt file tells search engine bots which pages they are allowed or not allowed to crawl.

**Crawling** is the process where a search engine bot (such as Googlebot) automatically visits and scans pages on your website to understand their content and structure.
