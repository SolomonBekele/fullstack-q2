...
### 12.2 JID
**JID (Jabber ID)** is the addressing scheme used in XMPP, similar to an email address.it is unique identifier for any xmpp entities(user,server,client,service component ...)
...
| Type          | Example                    | Entity  |
| ------------- | -------------------------- | ------- |
| Bare JID      | `alice@example.com`        | User    |
| Full JID      | `alice@example.com/mobile` | Client  |
| Domain JID    | `example.com`              | Server  |
| Component JID | `conference.example.com`   | Service |
